...
!(function (e, n) {
    ...
    var p = e(function (e, n) {
        e.exports = (function () {
            function r(e, n) {
                e
                    ? (t(e, n, "touchstart", "touchmove", "touchend"),
                        t(e, n, "mousedown", "mousemove", "mouseup"))
                    : console.warn("drag is missing elem!");
            }
            return (
                (r.xyslider = function (e) {
            ...
            function t(r, e, n, a, i) {
                var t,
                    ...
                    u,
                    s = (e = (t = e)
                        ? { begin: t.begin || p, change: t.change || p, end: t.end || p }
                        : {
                            begin: function (e) {
                                (o = { x: e.elem.offsetLeft, y: e.elem.offsetTop }),
                                    (u = e.cursor);
                            },
                            change: function (e) {
            ...
            function c(e, n, t) {
                ...
                e.addEventListener(n, t, !!r && { passive: !1 });
            }
            function h(e, n, t) {
            ...
            function g(e, n, t) {
                ...
                var r,
                    a,
                    i,
                    o = { x: (r = n.getBoundingClientRect()).left, y: r.top },
                    u = n.clientWidth,
                    s = n.clientHeight,
                    l = {
                        x:
        ...
        a = e(function (e, n) {
            e.exports = (function () {
                ...
                (c.namedColors = {}),
                        ...
                        (c[a] = function (e) {
                            ...
                            i.forEach(function (e, n) {
                                ...
                                if ("alpha" === e)
                                    ...
                                    if (isNaN(t))
                                        throw new Error(
                                            "[" + a + "]: Invalid color: (" + i.join(",") + ")"
                                        );
                                    "hue" === e
                                        ? (this._hue = t < 0 ? t - Math.floor(t) : t % 1)
                                        : (this["_" + e] = t < 0 ? 0 : 1 < t ? 1 : t);
                                }
                            }, this);
                        }).propertyNames = i;
                        var r = c[a].prototype;
                        for (var t in (["valueOf", "hex", "hexa", "css", "cssa"].forEach(
                            function (e) {
                                r[e] =
                                    r[e] ||
                                    ("RGB" === a
                            ...
                            if (e.hasOwnProperty(t)) {
                                var o = t.match(/^from(.*)$/);
                                o
                                    ? (c[o[1].toUpperCase()].prototype[a.toLowerCase()] = e[t])
                                    : (r[t] = e[t]);
                            }
                        return (
                            (r[a.toLowerCase()] = function () {
                                return this;
                            }),
                            (r.toString = function () {
                                return (
                    ...
                    (c.use = function (e) {
                        return (
                            -1 === c.pluginList.indexOf(e) && (this.pluginList.push(e), e(c)),
                            c
                        );
                    }),
                    ...
                    c.installColorSpace("RGB", ["red", "green", "blue", "alpha"], {
                        ...
                        hexa: function () {
                            ...
                            return (
                                "#" + "00".substr(0, 2 - e.length) + e + this.hex().substr(1, 6)
                            );
                        },
                        css: function () {
                            return (
                    ...
                    a.installColorSpace("XYZ", ["x", "y", "z", "alpha"], {
                        fromRgb: function () {
                            var e = function (e) {
                                ...
                                r = e(this._blue);
                            return new a.XYZ(
                                0.4124564 * n + 0.3575761 * t + 0.1804375 * r,
                                0.2126729 * n + 0.7151522 * t + 0.072175 * r,
                                0.0193339 * n + 0.119192 * t + 0.9503041 * r,
                                this._alpha
                            );
                        },
                        rgb: function () {
                            ...
                            return new a.RGB(
                                r(3.2404542 * e + -1.5371385 * n + -0.4985314 * t),
                                r(-0.969266 * e + 1.8760108 * n + 0.041556 * t),
                                r(0.0556434 * e + -0.2040259 * n + 1.0572252 * t),
                                this._alpha
                            );
                        },
                        lab: function () {
                ...
                return c
                        ...
                        a.use(n),
                            a.installColorSpace("LAB", ["l", "a", "b", "alpha"], {
                                ...
                                xyz: function () {
                                    var e = function (e) {
                                        var n = Math.pow(e, 3);
                                        return 0.008856 < n ? n : (e - 16 / 116) / 7.87;
                                    },
                                        n = (this._l + 16) / 116,
                                        t = this._a / 500 + n,
                                        r = n - this._b / 200;
                    ...
                    .use(function (e) {
                        e.installMethod("clearer", function (e) {
                            return this.alpha(isNaN(e) ? -0.1 : -e, !0);
                        });
                    })
                    .use(function (e) {
                        e.use(r),
                            e.installMethod("darken", function (e) {
                                return this.lightness(isNaN(e) ? -0.1 : -e, !0);
                            });
                    })
                    .use(function (e) {
                        e.use(r),
                            e.installMethod("desaturate", function (e) {
                                return this.saturation(isNaN(e) ? -0.1 : -e, !0);
                            });
                    })
                    .use(function (t) {
                        function e() {
                            var e = this.rgb(),
                                n = 0.3 * e._red + 0.59 * e._green + 0.11 * e._blue;
                    ...
                    .use(function (u) {
                        u.installMethod("mix", function (e, n) {
                            ...
                            return new u.RGB(
                                o._red * a + e._red * i,
                                o._green * a + e._green * i,
                                o._blue * a + e._blue * i,
                                o._alpha * n + e._alpha * (1 - n)
                            );
                        });
                    })
                    .use(function (n) {
    ...
    var r = {
            ...
            return (
                ...
                (t.input.onkeyup = function (e) {
                    var n = e.keyCode || e.which,
                        t = e.target.value;
                    (t = (function (e, n, t) {
                        for (var r = e, a = e.length; a < n; a++) r += t;
                        return r;
                    })((t = "#" == t[0] ? t : "#" + t), 7, "0")),
                        13 == n && r.set(t);
                }),
        ...
        y = function (r) {
            return (
                (e = s),
                (n = [r.init, r.xy, r.z]).map(e).filter(l).length != n.length
                        ...
                        return (function (e) {
                            ...
                            var r = e.cbs,
                                a = p.xyslider({
                                    parent: n,
                                    class: "twod",
                                    cbs: { begin: i, change: i, end: h },
                                });
                            function i(e) {
                                (l = r.xy(
                                    l,
                                    { x: v.clamp(e.x, 0, 1), y: v.clamp(e.y, 0, 1) },
                                    a,
                                    o
                                )),
                                    c();
                            ...
                            var d = {
                                ...
                                on: function (e, n, t) {
                                    return (
                                        "change" == e || "done" == e
                                            ? f[e].push({ name: t, fn: n })
                                            : console.warn(
                                                'Passed invalid evt name "' + e + '" to colorjoe.on'
                                            ),
                                        this
                                    );
                                },
    ...
    for (var i in ((y.rgb = y({
        init: function (e, n, t) {
            var r = a(e).hsv();
            return (
                this.xy(r, { x: r.saturation(), y: 1 - r.value() }, n, t),
                this.z(r, r.hue(), n, t),
                r
            );
        },
        ...
        (y.hsl = y({
            init: function (e, n, t) {
                var r = a(e).hsl();
                return (
                    this.xy(r, { x: r.hue(), y: 1 - r.saturation() }, n, t),
        ...
        (y.registerExtra = function (e, n) {
            e in y.extras &&
                console.warn('Extra "' + e + '"has been registered already!'),
                (y.extras[e] = n);
        }),
        r))
...
class ColorPicker {
    constructor(root) {
        ...
        this.colorjoe.on("change", (color) => {
            ...
            localStorage.setItem("selected-color", color.hex());
        ...
        document.querySelectorAll(".saved-color").forEach((el, i) => {
            ...
            el.addEventListener('contextmenu', (e) => { // Add contextmenu listener here
                e.preventDefault();
...
function checkTheme() {
    if (localStorage.getItem("theme") === "dark-mode") {
        ...
        document.querySelector('.colorpicker').style.backgroundColor = "#ffffff";
        document.querySelectorAll('.config-title').forEach((element) => {
